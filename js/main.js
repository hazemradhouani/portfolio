...
(function () {
  ...
  /* ─────────────────────────────────────────────────────────
     ...
     Activated only on the first real scroll event so it
     can never flash during page load or scroll-position
     restore that the browser does during navigation.
  ───────────────────────────────────────────────────────── */
  (function () {
    ...
    var barReady    = false;   /* true once first real scroll fires */
    ...
    window.addEventListener('scroll', function () {
      /* First real scroll: make bar visible in the DOM */
      if (!barReady) {
        barReady = true;
    ...
    /* Do NOT call updateBar() on init — wait for actual scroll */
  }());
