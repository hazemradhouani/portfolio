...
(function () {
  ...
  (function () {
    ...
    /* Always visible — one rAF delay so the browser paints the initial
       hidden state (opacity:0, translated) before adding is-visible.
       Without this the entrance transition doesn't play on first load. */
    requestAnimationFrame(function () {
      requestAnimationFrame(function () {
